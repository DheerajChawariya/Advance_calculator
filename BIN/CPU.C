...
loop:
    ...
    printf("6) Division \n");
    printf("7) Find Area \n");
    printf("8) Find Perameter \n");
    printf("9) Convert Temperature \n");
    printf("10) Power Based Calculation \n");
    printf("==================================================\n");
	...
	else if (ff1 == 4)
	{
		...
		printf("One Side : ");
		scanf("%f",&side11);
		printf("root3 x a x a /4 \n");
		printf("%f is area of triangle. \n", 1.73 * side11*side11/4);
	    }
	}
	else if (ff1 == 5)
	{
	...
	else if (ff1 == 11)
	{
	    ...
	    printf("Radius \n");
	    printf("%f", &radiussss);
	    printf("%f is area of Sphere.", 4*PHI*radiussss*radiussss);
	}
	else if (ff1 == 12)
	{
    ...
    else if (a == 8)
	{
	    ...
	    printf("2) Perameter of Rectangle\n");
	    printf("3) Perameter of Triangle\n");
	    printf("4) Perameter of Circle \n");
	    printf("5) Many More \n");
	    printf("Select Option : ");
	    scanf("%d",&fff11);
	    if (fff11==1)
	    {
		float ps;
		printf("Perameter of Square \n");
		printf("Side : ");
		scanf("%f",&ps);
		printf(" %f is Perameter of Square \n", 4*ps);

	    }
	    else if (fff11==2)
	    {
		int pb,pl;
		printf("Perameter of Rectangle\n");
		printf("Breadth : ");
		scanf("%f",&pb);
		printf("Length : ");
		scanf("%f",&pl);
	    ...
	    {
		float pc;
		printf("Perameter of Circle \n");
		printf("Radius : ");
		scanf("%f",&pc);
		printf(" %f is Perameter of Circle \n", 2 * PHI * pc);
	    }
	    if (fff11==5)
	    {
		printf("Reaming formula update soon \n");
    ...
    else if (a == 9)
	{
		...
		scanf("%f",&celsius1);
		printf("F = C(9/5)+32");
		printf("Fahrenheit = %f ",celsius1*1.8+32);
	    }
	    else if (fff12 == 2)
	    {
		float fahrenhit1;
		...
		scanf("%f",&fahrenhit1);
		printf("C = (F-32) x 5/9");
		printf("Celsius = %f ",(fahrenhit1-32)*0.6);
	    }
	    else if (fff12 == 3)
	    {
		float kelvin1;
		...
		scanf("%f",&kelvin1);
		printf("C = K - 275.15");
		printf("Celsius = %f ",kelvin1-273.15);
	    }
	    else if (fff12 == 4)
	    {
		float celsius1;
		...
		scanf("%f",&celsius1);
		printf("K = C + 273.15");
		printf("Kelvin = %f ",celsius1+273.15);
	    }
	    else if (fff12 == 5)
	    {
		float fahrenheit2;
		...
		printf("Fahrenheit : ");
		scanf("%f",&fahrenheit2);
		printf("K = (F - 32) x 5/9 + 273.15");
		printf("Kelvin = %f ",(fahrenheit2-32)*0.6+273.15);
	    }
	    else if (fff12 == 6)
	    {
		float kelvin1;
		...
		printf("Kelvin : ");
		scanf("%f",&kelvin1);
		printf("F = (K - 273.15) x 9/5 +32");
		printf("Fahrenheit = %f ",(kelvin1 - 273.15) * 1.8 +32);
	    }

	}
	 else if (a==10)
	{
	float power1,number2;
	    printf("Power Based Calculation \n");
	    printf("Enter Number : ");
	    scanf("%f",&number2);
	    printf("Enter Power : ");
	    scanf("%f",&power1);
	    printf("%.1f's power %.1f is : ",number2,power1);
	    printf("%f", pow(number2,power1));
	}
